...
import com.student.model.ext.ExchangeStudent;
...
public class LabDriver {
	...
	public static void main(String args[]) {
		...
		Student studentA = new Student("Troy");
		...
		Student studentB = new Student("Jane");
		...
		ExchangeStudent studentC = new ExchangeStudent("Dan");
